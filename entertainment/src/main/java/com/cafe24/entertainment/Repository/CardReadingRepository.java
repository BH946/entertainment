...
public interface CardReadingRepository extends JpaRepository<CardReading, Long> {
  ...
  List<CardReading> findByTarotCardAndReadingCategoryNot(TarotCard tarotCard, ReadingCategory readingCategory);
  List<CardReading> findByTarotCardAndReadingCategory(TarotCard tarotCard, ReadingCategory readingCategory);
}
